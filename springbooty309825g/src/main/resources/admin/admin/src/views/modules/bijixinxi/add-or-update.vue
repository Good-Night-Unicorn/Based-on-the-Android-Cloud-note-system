		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="笔记名称" prop="bijimingcheng" >
					<el-input v-model="ruleForm.bijimingcheng" placeholder="笔记名称" clearable  :readonly="ro.bijimingcheng"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="笔记名称" prop="bijimingcheng" >
					<el-input v-model="ruleForm.bijimingcheng" placeholder="笔记名称" readonly></el-input>
				</el-form-item>
				...
				<el-form-item v-else class="input" label="链接" prop="lianjie" >
			...
			<el-form-item class="textarea" v-if="type!='info'" label="笔记摘要" prop="bijizhaiyao" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="笔记摘要"
					v-model="ruleForm.bijizhaiyao" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.bijizhaiyao" label="笔记摘要" prop="bijizhaiyao" >
				<span class="text">{{ruleForm.bijizhaiyao}}</span>
			</el-form-item>
			<el-form-item v-if="type!='info'"  label="笔记内容" prop="bijineirong" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.bijineirong" 
					class="editor"
					myQuillEditor="bijineirong"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.bijineirong" label="笔记内容" prop="bijineirong" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.bijineirong"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.bijineirong = this.ruleForm.bijineirong.replace(reg,'../../../springbooty309825g/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
