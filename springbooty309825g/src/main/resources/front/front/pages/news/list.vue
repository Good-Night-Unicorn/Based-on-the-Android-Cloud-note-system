		...
		<view class="content">
			<view :style='{"minHeight":"100%","padding":"0 20rpx","flexWrap":"wrap","background":"#F9FAFA","display":"flex","width":"100%","position":"relative","height":"auto"}'>
				...
				<view :style='{"width":"100%","flexWrap":"wrap","background":"none","display":"flex","height":"auto","order":"5"}'>
					...
					<!-- 样式4 -->
					<view v-if="list.length" class="news-box4" :style='{"width":"0","padding":"0","margin":"0","flex":"auto","height":"auto"}'>
						<block v-for="(product,index) in list" :key="index">
							<view @tap="onDetailTap(product)" v-if="index%2==0" class="list-item" :style='{"width":"100%","boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"0 0 20rpx","flexWrap":"wrap","display":"flex","height":"auto"}'>
								<image :style='{"width":"200rpx","objectFit":"cover","display":"block","height":"auto"}' mode="aspectFill" class="listmpic" :src="baseUrl+product.picture"></image>
								<view class="list-item-body" :style='{"width":"calc(100% - 200rpx)","padding":"0","margin":"0","height":"auto"}'>
									<view :style='{"padding":"0 20rpx","margin":"0","color":"#333","width":"100%","lineHeight":"1.5","fontSize":"28rpx","fontWeight":"600"}' class="title ">{{product.title}}</view>
									<view :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#666","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","height":"80rpx"}' class="text ">{{product.introduction}}</view>
							...
							<view @tap="onDetailTap(product)" v-if="index%2==1" class="list-item" :style='{"width":"100%","boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"0 0 20rpx","flexWrap":"wrap","display":"flex","height":"auto"}'>
								<view class="list-item-body" :style='{"width":"calc(100% - 200rpx)","padding":"0","margin":"0","height":"auto"}'>
									<view :style='{"width":"100%","padding":"0 20rpx","margin":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333"}' class="title ">{{product.title}}</view>
									<view :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#666","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","height":"80rpx"}' class="text ">{{product.introduction}}</view>
									<view :style='{"padding":"0 20rpx"}'>
										<text class="icon iconfont icon-shijian21" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"24rpx","color":"#666"}'></text>
										<text :style='{"color":"#666","lineHeight":"1.5","fontSize":"24rpx"}'>{{product.addtime.replace(/\-/g,'-').replace(/\:/g,':')}}</text>
