				...
				<view :style='{"width":"100%","flexWrap":"wrap","background":"none","display":"flex","height":"auto","order":"5"}'>
					<view class="uni-product-list" :style='{"padding":"0","margin":"0","flexWrap":"wrap","flex":"auto","display":"flex","width":"0","justifyContent":"space-between","height":"auto"}'>
						<view @tap="onDetailTap(product)" class="uni-product" :style='{"width":"48%","boxShadow":"none","margin":"0 0 20rpx","backgroundColor":"#F3F9FF","height":"auto"}' v-for="(product,index) in list" :key="index">
							<view class="uni-product-title " :style='{"padding":"4rpx 20rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#000","maxHeight":"48rpx","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","textOverflow":"ellipsis","fontWeight":"600"}'>{{product.name}}</view>
