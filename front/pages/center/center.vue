<template>
	<view class="content">
		<view :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#F9FAFA","height":"auto"}'>
			<view v-if="user&&user.id" :style='{"padding":"40rpx 24rpx","margin":"0 0 20rpx 0","background":"none","display":"flex","width":"100%","position":"relative","height":"auto"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"alignContent":"center","alignItems":"center","flexWrap":"wrap","flex":"1","display":"flex","height":"100%"}' v-if="tableName=='yonghu'" class="userinfo">
					...
					<view :style='{"width":"240rpx","flex":"1","flexDirection":"column","justifyContent":"center","display":"flex"}' class="info">
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"24rpx","color":"#000000"}'>{{user.yonghuming}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					
					<view :style='{"padding":"20rpx 0","margin":"20rpx 0 0","color":"#000000","flexDirection":"row","background":"#FFFFFF","display":"flex","gap":"20rpx","width":"100%","flexFlow":"wrap","justifyContent":"center"}' class="info">
						<view :style='{"padding":"8rpx","borderRadius":"12rpx","color":"inherit","textAlign":"center","background":"none","flexDirection":"column","display":"flex","width":"30%","lineHeight":"36rpx","fontSize":"24rpx"}'>
							<span :style='{"color":"inherit"}'>手机：</span>
							<span :style='{"color":"inherit"}'>{{user.shouji}}</span>
						</view>
					</view>
				</view>
				<view :style='{"padding":"0 0 0 20rpx","alignItems":"center","top":"36rpx","flexDirection":"column","display":"flex","width":"84rpx","position":"absolute","right":"30rpx","justifyContent":"center","height":"auto"}' class="setting">
					<text class="icon iconfont icon-qita6" :style='{"border":"0","width":"48rpx","lineHeight":"48rpx","fontSize":"48rpx","color":"#000000","borderRadius":"0"}'></text>
					<text :style='{"color":"#000000","lineHeight":"2","fontSize":"24rpx"}'>设置</text>
				</view>
			</view>
			
			<view v-else :style='{"padding":"40rpx 24rpx","margin":"0 0 20rpx 0","background":"none","display":"flex","width":"100%","position":"relative","height":"auto"}' @tap="loginClick" class="header" v-bind:class="{'status':isH5Plus}">
			...
			<view :style='{"width":"100%","background":"none","height":"auto"}' class="list">
				...
				<view :style='{"width":"100%","margin":"40rpx 0 0","height":"auto"}'>
					<view :style='{"padding":"20rpx 0 0","margin":"0","color":"#fff","background":"none","display":"flex","width":"100%","letterSpacing":"2rpx","fontSize":"32rpx","position":"relative","justifyContent":"center","fontWeight":"600","height":"152rpx"}'>
						<view :style='{"padding":"8rpx 0 0","margin":"0","color":"#fff","background":"url(http://codegen.caihongy.cn/20250219/f42cc2e72e884f0ab71bbf038eb06c49.png) no-repeat center / 100% 100%","display":"flex","width":"100%","fontSize":"32rpx","position":"relative","justifyContent":"center","fontWeight":"600","height":"136rpx"}'>我的服务</view>
					</view>
			...
			<view class="recommend" :style='{"width":"100%","padding":"0 0 40rpx 0","margin":"40rpx 0 0","background":"#fff","height":"auto"}' v-if="recommendList.length">
				<view :style='{"padding":"8rpx 0 0","margin":"0","color":"#fff","background":"url(http://codegen.caihongy.cn/20250219/f42cc2e72e884f0ab71bbf038eb06c49.png) no-repeat center / 100% 100%","display":"flex","width":"100%","fontSize":"32rpx","position":"relative","justifyContent":"center","fontWeight":"600","height":"136rpx"}'>为你推荐</view>
				<view :style='{"padding":"0 20rpx","margin":"40rpx 0 0","flexWrap":"wrap","background":"#fff","display":"flex","gap":"20rpx","width":"100%","justifyContent":"space-between","height":"auto"}'>
					<view v-for="(item,index) in recommendList" :key="index" :style='{"border":"none","padding":"20rpx","alignItems":"center","background":"#F5FFFF","flexDirection":"column","display":"flex","width":"48%","position":"relative","justifyContent":"center","height":"auto"}' @click="recommendDetail(item.id)">
						<image v-if="preHttp(item[recommendPicture])" :style='{"width":"100%","objectFit":"cover","borderRadius":"20rpx","display":"block","height":"160rpx"}' :src="item[recommendPicture]"></image>
						<image v-else :style='{"width":"100%","objectFit":"cover","borderRadius":"20rpx","display":"block","height":"160rpx"}' :src="item[recommendPicture]?(baseUrl + item[recommendPicture].split(',')[0]):''"></image>
	...
	export default {
		...
		methods: {
			...
			async getRecommendList(){
				...
				this.recommendTable = 'bijixinxi'
				this.recommendTitle = 'bijimingcheng'
