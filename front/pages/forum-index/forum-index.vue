<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
		...
		<view :style='{"minHeight":"100%","padding":"10rpx","flexWrap":"wrap","background":"#F4F4F4","display":"flex","width":"100%","height":"auto"}'>
			<!--header end-->
			<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx 24rpx","background":"none","display":"flex","height":"auto"}'>
				<view class="search-form round" :style='{"border":"2rpx solid #6683A2","margin":"0 12rpx 0 0","position":"relative","flex":"1"}'>
				...
				<button :style='{"border":"0","padding":"0px","margin":"0","color":"#fff","borderRadius":"20rpx","background":"linear-gradient( 135deg, #469CF5 0%, #25CCB4 100%)","width":"136rpx","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}' @tap="search" class="cu-btn shadow-blur round">搜索</button>
			</view>
